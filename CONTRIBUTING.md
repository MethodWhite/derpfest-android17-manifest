...
Las contribuciones asistidas por IA deben seguir [`docs/42-ai-micromodular-contribution-protocol.md`](docs/42-ai-micromodular-contribution-protocol.md): investigar impacto, agrupar correcciones de la misma familia, mantener dependencias explícitas, validar por capas y entregar microcommits revisables. Consulta también los [estándares de gobernanza](docs/governance/PROJECT_GOVERNANCE.md).
